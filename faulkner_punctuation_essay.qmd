...
[^1]: Before it became possible to do computational analysis of texts, there have been any number of precursors that anticipate the methodology. The most extensive of these are the textual concordances published by the Faulkner Concordance Advisory Board. The work of Virginia Hlavsa in 1991 also uses word counts to make its argument [@hlavsa1991 51-53]. More recently, Charles Hannon has used these techniques with *As I Lay Dying* [@hannon2015]
